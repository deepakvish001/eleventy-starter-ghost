...
Define the bug report template standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The bug report template requirement is observable at build time or in generated output.
