...
Define the continuous integration standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The continuous integration requirement is observable at build time or in generated output.
...
Keep implementation work focused on one continuous integration outcome and record unrelated template or content-model changes separately.