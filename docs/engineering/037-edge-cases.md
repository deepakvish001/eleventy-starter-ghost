...
Define the edge cases standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The edge cases requirement is observable at build time or in generated output.
...
Keep implementation work focused on one edge cases outcome and record unrelated template or content-model changes separately.