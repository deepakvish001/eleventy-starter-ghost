...
Define the css architecture standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The css architecture requirement is observable at build time or in generated output.
...
Keep implementation work focused on one css architecture outcome and record unrelated template or content-model changes separately.