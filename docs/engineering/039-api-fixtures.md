...
Define the api fixtures standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The api fixtures requirement is observable at build time or in generated output.
...
Keep implementation work focused on one api fixtures outcome and record unrelated template or content-model changes separately.