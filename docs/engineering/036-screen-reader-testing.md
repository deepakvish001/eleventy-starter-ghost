...
Define the screen reader testing standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The screen reader testing requirement is observable at build time or in generated output.
...
Keep implementation work focused on one screen reader testing outcome and record unrelated template or content-model changes separately.