...
Define the feature flags standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The feature flags requirement is observable at build time or in generated output.
