...
Define the dependency updates standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The dependency updates requirement is observable at build time or in generated output.
