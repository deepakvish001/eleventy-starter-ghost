...
Define the live regions standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The live regions requirement is observable at build time or in generated output.
...
Keep implementation work focused on one live regions outcome and record unrelated template or content-model changes separately.