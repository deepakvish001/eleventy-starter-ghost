...
Define the design tokens standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The design tokens requirement is observable at build time or in generated output.
...
Keep implementation work focused on one design tokens outcome and record unrelated template or content-model changes separately.