...
Define the test data standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The test data requirement is observable at build time or in generated output.
...
Keep implementation work focused on one test data outcome and record unrelated template or content-model changes separately.