...
Define the output escaping standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The output escaping requirement is observable at build time or in generated output.
