...
Define the content model standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The content model requirement is observable at build time or in generated output.
...
Keep implementation work focused on one content model outcome and record unrelated template or content-model changes separately.