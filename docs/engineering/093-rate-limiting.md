...
Define the rate limiting standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The rate limiting requirement is observable at build time or in generated output.
