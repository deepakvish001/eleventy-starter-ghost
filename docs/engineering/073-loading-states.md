...
Define the loading states standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The loading states requirement is observable at build time or in generated output.
...
Keep implementation work focused on one loading states outcome and record unrelated template or content-model changes separately.