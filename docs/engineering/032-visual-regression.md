...
Define the visual regression standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The visual regression requirement is observable at build time or in generated output.
...
Keep implementation work focused on one visual regression outcome and record unrelated template or content-model changes separately.