...
Define the post rendering standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The post rendering requirement is observable at build time or in generated output.
...
Keep implementation work focused on one post rendering outcome and record unrelated template or content-model changes separately.