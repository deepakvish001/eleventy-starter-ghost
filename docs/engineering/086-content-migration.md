...
Define the content migration standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The content migration requirement is observable at build time or in generated output.
