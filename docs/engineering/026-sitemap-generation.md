...
Define the sitemap generation standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The sitemap generation requirement is observable at build time or in generated output.
...
Keep implementation work focused on one sitemap generation outcome and record unrelated template or content-model changes separately.