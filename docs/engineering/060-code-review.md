...
Define the code review standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The code review requirement is observable at build time or in generated output.
...
Keep implementation work focused on one code review outcome and record unrelated template or content-model changes separately.