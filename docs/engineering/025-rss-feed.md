...
Define the rss feed standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The rss feed requirement is observable at build time or in generated output.
...
Keep implementation work focused on one rss feed outcome and record unrelated template or content-model changes separately.