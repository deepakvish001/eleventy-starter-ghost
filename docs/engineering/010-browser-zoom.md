...
Define the browser zoom standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The browser zoom requirement is observable at build time or in generated output.
...
Keep implementation work focused on one browser zoom outcome and record unrelated template or content-model changes separately.