...
Define the maintenance policy standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The maintenance policy requirement is observable at build time or in generated output.
