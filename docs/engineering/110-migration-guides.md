...
Define the migration guides standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The migration guides requirement is observable at build time or in generated output.
