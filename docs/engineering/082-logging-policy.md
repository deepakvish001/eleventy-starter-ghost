...
Define the logging policy standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The logging policy requirement is observable at build time or in generated output.
