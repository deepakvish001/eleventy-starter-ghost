...
Define the featured content standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The featured content requirement is observable at build time or in generated output.
...
Keep implementation work focused on one featured content outcome and record unrelated template or content-model changes separately.