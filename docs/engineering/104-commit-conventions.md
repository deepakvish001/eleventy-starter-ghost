...
Define the commit conventions standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The commit conventions requirement is observable at build time or in generated output.
