...
Define the netlify deployment standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The netlify deployment requirement is observable at build time or in generated output.
...
Keep implementation work focused on one netlify deployment outcome and record unrelated template or content-model changes separately.