...
Define the privacy model standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The privacy model requirement is observable at build time or in generated output.
...
Keep implementation work focused on one privacy model outcome and record unrelated template or content-model changes separately.