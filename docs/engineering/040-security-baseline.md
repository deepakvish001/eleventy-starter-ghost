...
Define the security baseline standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The security baseline requirement is observable at build time or in generated output.
...
Keep implementation work focused on one security baseline outcome and record unrelated template or content-model changes separately.