...
Define the architecture decisions standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The architecture decisions requirement is observable at build time or in generated output.
