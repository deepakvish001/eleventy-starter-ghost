...
Define the document language standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The document language requirement is observable at build time or in generated output.
...
Keep implementation work focused on one document language outcome and record unrelated template or content-model changes separately.