...
Define the compatibility policy standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The compatibility policy requirement is observable at build time or in generated output.
...
Keep implementation work focused on one compatibility policy outcome and record unrelated template or content-model changes separately.