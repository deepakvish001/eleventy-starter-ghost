...
Define the observability standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The observability requirement is observable at build time or in generated output.
