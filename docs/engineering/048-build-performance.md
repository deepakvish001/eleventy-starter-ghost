...
Define the build performance standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The build performance requirement is observable at build time or in generated output.
...
Keep implementation work focused on one build performance outcome and record unrelated template or content-model changes separately.