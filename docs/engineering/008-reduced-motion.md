...
Define the reduced motion standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The reduced motion requirement is observable at build time or in generated output.
...
Keep implementation work focused on one reduced motion outcome and record unrelated template or content-model changes separately.