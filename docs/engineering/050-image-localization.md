...
Define the image localization standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The image localization requirement is observable at build time or in generated output.
...
Keep implementation work focused on one image localization outcome and record unrelated template or content-model changes separately.