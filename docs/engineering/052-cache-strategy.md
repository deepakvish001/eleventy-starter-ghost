...
Define the cache strategy standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The cache strategy requirement is observable at build time or in generated output.
...
Keep implementation work focused on one cache strategy outcome and record unrelated template or content-model changes separately.