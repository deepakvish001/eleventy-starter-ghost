...
Define the linting standard standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The linting standard requirement is observable at build time or in generated output.
...
Keep implementation work focused on one linting standard outcome and record unrelated template or content-model changes separately.