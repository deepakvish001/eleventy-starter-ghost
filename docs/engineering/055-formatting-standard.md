...
Define the formatting standard standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The formatting standard requirement is observable at build time or in generated output.
...
Keep implementation work focused on one formatting standard outcome and record unrelated template or content-model changes separately.