...
Define the page metadata standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The page metadata requirement is observable at build time or in generated output.
...
Keep implementation work focused on one page metadata outcome and record unrelated template or content-model changes separately.