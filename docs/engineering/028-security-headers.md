...
Define the security headers standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The security headers requirement is observable at build time or in generated output.
...
Keep implementation work focused on one security headers outcome and record unrelated template or content-model changes separately.