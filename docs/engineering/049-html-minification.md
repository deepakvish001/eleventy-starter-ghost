...
Define the html minification standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The html minification requirement is observable at build time or in generated output.
...
Keep implementation work focused on one html minification outcome and record unrelated template or content-model changes separately.