...
Define the theme contract standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The theme contract requirement is observable at build time or in generated output.
...
Keep implementation work focused on one theme contract outcome and record unrelated template or content-model changes separately.