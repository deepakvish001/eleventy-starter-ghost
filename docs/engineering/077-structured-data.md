...
Define the structured data standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The structured data requirement is observable at build time or in generated output.
...
Keep implementation work focused on one structured data outcome and record unrelated template or content-model changes separately.