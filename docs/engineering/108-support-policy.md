...
Define the support policy standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The support policy requirement is observable at build time or in generated output.
