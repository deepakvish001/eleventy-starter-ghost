...
Define the form semantics standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The form semantics requirement is observable at build time or in generated output.
...
Keep implementation work focused on one form semantics outcome and record unrelated template or content-model changes separately.