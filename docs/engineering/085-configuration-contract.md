...
Define the configuration contract standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The configuration contract requirement is observable at build time or in generated output.
