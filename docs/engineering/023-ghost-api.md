...
Define the ghost api standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The ghost api requirement is observable at build time or in generated output.
...
Keep implementation work focused on one ghost api outcome and record unrelated template or content-model changes separately.