...
Define the health checks standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The health checks requirement is observable at build time or in generated output.
