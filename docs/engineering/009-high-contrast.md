...
Define the high contrast standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The high contrast requirement is observable at build time or in generated output.
...
Keep implementation work focused on one high contrast outcome and record unrelated template or content-model changes separately.