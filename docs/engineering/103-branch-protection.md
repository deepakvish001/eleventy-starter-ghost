...
Define the branch protection standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The branch protection requirement is observable at build time or in generated output.
