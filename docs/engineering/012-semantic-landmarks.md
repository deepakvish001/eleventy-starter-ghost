...
Define the semantic landmarks standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The semantic landmarks requirement is observable at build time or in generated output.
...
Keep implementation work focused on one semantic landmarks outcome and record unrelated template or content-model changes separately.