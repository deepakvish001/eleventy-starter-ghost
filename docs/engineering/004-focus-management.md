...
Define the focus management standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The focus management requirement is observable at build time or in generated output.
...
Keep implementation work focused on one focus management outcome and record unrelated template or content-model changes separately.