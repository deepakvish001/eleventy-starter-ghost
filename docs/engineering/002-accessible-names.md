...
Define the accessible names standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The accessible names requirement is observable at build time or in generated output.
...
Keep implementation work focused on one accessible names outcome and record unrelated template or content-model changes separately.