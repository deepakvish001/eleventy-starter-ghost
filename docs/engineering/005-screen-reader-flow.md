...
Define the screen reader flow standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The screen reader flow requirement is observable at build time or in generated output.
...
Keep implementation work focused on one screen reader flow outcome and record unrelated template or content-model changes separately.