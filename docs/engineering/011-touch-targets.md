...
Define the touch targets standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The touch targets requirement is observable at build time or in generated output.
...
Keep implementation work focused on one touch targets outcome and record unrelated template or content-model changes separately.