...
Define the localization plan standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The localization plan requirement is observable at build time or in generated output.
...
Keep implementation work focused on one localization plan outcome and record unrelated template or content-model changes separately.