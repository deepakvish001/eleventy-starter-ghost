...
Define the keyboard navigation standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The keyboard navigation requirement is observable at build time or in generated output.
...
Keep implementation work focused on one keyboard navigation outcome and record unrelated template or content-model changes separately.