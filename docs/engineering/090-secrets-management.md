...
Define the secrets management standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The secrets management requirement is observable at build time or in generated output.
