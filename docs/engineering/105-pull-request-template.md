...
Define the pull request template standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The pull request template requirement is observable at build time or in generated output.
