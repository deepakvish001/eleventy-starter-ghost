...
Define the local development standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The local development requirement is observable at build time or in generated output.
...
Keep implementation work focused on one local development outcome and record unrelated template or content-model changes separately.