...
Define the release process standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The release process requirement is observable at build time or in generated output.
...
Keep implementation work focused on one release process outcome and record unrelated template or content-model changes separately.