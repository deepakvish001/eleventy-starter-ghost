...
Define the repository layout standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The repository layout requirement is observable at build time or in generated output.
...
Keep implementation work focused on one repository layout outcome and record unrelated template or content-model changes separately.