...
Define the environment validation standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The environment validation requirement is observable at build time or in generated output.
