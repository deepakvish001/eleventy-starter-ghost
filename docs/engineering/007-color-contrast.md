...
Define the color contrast standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The color contrast requirement is observable at build time or in generated output.
...
Keep implementation work focused on one color contrast outcome and record unrelated template or content-model changes separately.