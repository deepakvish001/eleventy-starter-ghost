...
Define the responsive layout standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The responsive layout requirement is observable at build time or in generated output.
...
Keep implementation work focused on one responsive layout outcome and record unrelated template or content-model changes separately.