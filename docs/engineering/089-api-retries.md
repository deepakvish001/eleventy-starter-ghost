...
Define the api retries standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The api retries requirement is observable at build time or in generated output.
