...
Define the heading hierarchy standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The heading hierarchy requirement is observable at build time or in generated output.
...
Keep implementation work focused on one heading hierarchy outcome and record unrelated template or content-model changes separately.