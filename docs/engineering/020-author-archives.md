...
Define the author archives standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The author archives requirement is observable at build time or in generated output.
...
Keep implementation work focused on one author archives outcome and record unrelated template or content-model changes separately.