...
Define the incremental builds standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The incremental builds requirement is observable at build time or in generated output.
...
Keep implementation work focused on one incremental builds outcome and record unrelated template or content-model changes separately.