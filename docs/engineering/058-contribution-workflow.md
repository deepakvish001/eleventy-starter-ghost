...
Define the contribution workflow standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The contribution workflow requirement is observable at build time or in generated output.
...
Keep implementation work focused on one contribution workflow outcome and record unrelated template or content-model changes separately.