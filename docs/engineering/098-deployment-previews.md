...
Define the deployment previews standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The deployment previews requirement is observable at build time or in generated output.
