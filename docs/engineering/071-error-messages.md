...
Define the error messages standard for Ghostleaf so Ghost content is transformed into predictable, accessible, and deployable Eleventy output.
...
- The error messages requirement is observable at build time or in generated output.
...
Keep implementation work focused on one error messages outcome and record unrelated template or content-model changes separately.